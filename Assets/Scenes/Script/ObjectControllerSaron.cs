//-----------------------------------------------------------------------
// <copyright file="ObjectControllerSaron.cs" company="Google LLC">
...
/// </summary>
public class ObjectControllerSaron : MonoBehaviour
{
    /// <summary>
    ...
    private const float x_place=2.0f;
    private const float y_place=1f;
    private const float z_place=2.0f;
    int time,timeOut;
    bool gazed;
    bool stat;
