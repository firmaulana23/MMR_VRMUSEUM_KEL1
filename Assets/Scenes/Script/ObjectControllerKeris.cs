//-----------------------------------------------------------------------
// <copyright file="ObjectControllerKeris.cs" company="Google LLC">
...
/// </summary>
public class ObjectControllerKeris : MonoBehaviour
{
    /// <summary>
    ...
    private const float x_place=0.8f;
    private const float y_place=1f;
    private const float z_place=-2f;
    int time,timeOut;
    bool gazed;
    bool stat;
